                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/80 transition">
                            <td class="px-6 py-5 flex items-start gap-4">
                                <div class="w-10 h-14 bg-gray-200 rounded border border-gray-200 flex items-center justify-center flex-shrink-0 text-gray-400 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-gradient-to-tr from-gray-300 to-gray-100 opacity-50"></div>
                                    <i class="fa-solid fa-book text-xl relative z-10"></i>
                                </div>
                                <div>
                                    <p class="font-bold text-gray-900 text-[13px]"><?php echo htmlspecialchars($row['judul']); ?></p>
